...
public enum OpCode {
  ...
  IFGT(2), // 157 (0x9D)
  IFLE(2), // 158 (0x9E)
  IF__ICMPEQ(2), // 159 (0x9F)
  IF__ICMPNE(2), // 160 (0xA0)
  IF__ICMPLT(2), // 161 (0xA1)
  IF__ICMPGE(2), // 162 (0xA2)
  IF__ICMPGT(2), // 163 (0xA3)
  IF__ICMPLE(2), // 164 (0xA4)
  IF__ACMPEQ(2), // 165 (0xA5)
  IF__ACMPNE(2), // 166 (0xA6)
  GOTO(2), // 167 (0xA7)
  JSR(2), // 168 (0xA8)
  RET(1), // 169 (0xA9)
