...
public class Assert extends org.junit.Assert {
  ...
  public static void assertThat(final String reason, final int i, final Matcher<Integer> m) {
    org.junit.Assert.assertThat(reason, new Integer(i), cantBeNull(m));
  }
  ...
  public static Matcher<Boolean> not(final boolean b) {
    return cantBeNull(org.hamcrest.core.IsNot.not(Boolean.valueOf(b)));
  }
