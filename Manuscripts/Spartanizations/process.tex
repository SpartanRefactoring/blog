...
art~\cite{Griswold:Chen:Morison:Bowdidge:1998,Holmes:Murphy:2005}.  This
section is concerned with the full process of spartanization.
...
\begin{enumerate}
  \item Notice that the original code is a statement, while the transformed is
        ...
        \cref{eq:ternary} can be \textbf{applied}, %. next to to can 
