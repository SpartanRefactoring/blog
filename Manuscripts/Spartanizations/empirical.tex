...
there are some artifacts (with many \kk{import}s and comments),
...
Crucial to our trial of spartanization is the comparison of the penultimate
...
% This comparison, namely the difference between the compression ratio (approximate naturalness)
% and the corresponding values for the original code (as reported in \cref{table:original}),
% shows the improvement or decrement of naturalness of the software after spartanization.
...
\begin{table}
  ...
  naturalness due after \emph{structural spartanization} (first two columns) and
...
=======
      \sffamily  Ave.  & -0.33 & 0.06  & -0.28  &  -0.03 \\ % 0.06  & -1.95  \\
      \sffamily  Min.  &  -10.38 & -0.37 & -10.33 &  -0.40 \\% 0.01  &  0.40  \\  
      \sffamily  Max.  & 0.18 & 0.49  &  0.21  &   0.41 \\% 0.11  & -55.46 \\
      \sffamily  Med.  &  0.07 & 0.08  &  0.12  & -0.003 \\ % 0.29  &  0.62  \\
      \sffamily  Range & 10.55 & 0.86  & 10.54  &   0.81 \\% 0.10  & -55.86 \\
>>>>>>> 5a5252f982bf87d9bd211f7036655fb63439496a
      \bottomrule
    \end{tabular}
  \end{adjustbox}
...
% the compression power and the approximate naturalness between the two case: Total, when
...
<<<<<<< HEAD
  ...
  approximate naturaleness between the \emph{Total} spartanization (\emph{Structural} and
=======
  \caption{Aggregating statistics for the comparison of the compression power and 
