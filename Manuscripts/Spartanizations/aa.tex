...
The same reasoning applies to other resolution of style debates; one may also
  ...
  allows only one indentation style, or making any violation of the law of
...
Some recent studies~\cite{Gil:Lalouche:16,
  Gil:Goldstein:Moshkovich:2011,
  Zhang:Zheng:Ying:Hassan:16} 
