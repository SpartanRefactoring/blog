...
During the course of the years a tool which automatically apply 
perform the spartanizations, namely transformation of codes according to the spartan rules, has been developed.
