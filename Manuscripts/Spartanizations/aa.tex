...
If one parse the results of the query \kk{code conventions}
...
% a subject not necessarily of less interest, but something more related to the personal tastes. 
% So according to the latin \emph{motto}
% It migh be presumed maybe because code conventions are perceived by developers as somewhat 
% strictly rel
