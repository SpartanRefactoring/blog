...
such as \[
  \text{\cc{accumulate.to(myCollection).add(x).addAll(myCollection)}}.
\]
...
It seems that both practitioners and researchers perceive code style something unrelated to other most
