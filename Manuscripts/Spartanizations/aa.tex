...
% It was introduced in the mid on ninties
% and it has been a part of some teachings. 
...
This tools applies to Java code and has been implemented as a plugin for the Eclipse\urlref{https://eclipse.org/} 
...
% reducing code complexity by applying many techniques, some already known in
% literature, some others more novel. It was introduced in the mid on ninties
% and it has been a part of some teachings. Its rationale is based on some
% principles, but at the end of the day it is a technique to pursue an extreme
