...
single one byte token. The rationale is that keywords such as \kk{class} are
...
Jack currently does not remove unit-tests, but is planned to do so in the future.
