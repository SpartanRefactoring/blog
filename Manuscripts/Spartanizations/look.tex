...
\begin{figure}[ht]
  \matteo\footnote{incorrect} \caption{Spartan functions to test for primality%
\footnote{https://github.com/SpartanRefactoring/spartan/blob/master/src/il/org/spartan/misc/Primes.java}}
\caption{An example of spartan code}
