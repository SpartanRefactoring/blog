...
The \Java \kk{class} lookalike of environment
\cc{.Date} of \cref{figure:data:reap}.
  }
\begin{java}
class Date {
  Integer d, m, y;
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item \emph{Empty cells:} We say that a property is \emph{free} if this property
        ...
        values. We see that values of~\cc{d} and \cc{infinite} are non-missing.

        The reason is that by the lazy caching semantics means the assignment to \cc{d} 
        ...
        The  read of property \cc{infinite} triggers a computation of
        the recipe, which returns \kk{True}.  However a read of any other
        ...
        and \cc{zero} retain their current~$⊥$ value as well.
        ...
        The resulting prerequisites' is portrayed in \Cref{figure:rational:2}.
          ...
          the recipe is triggered, none of~\cc{n} and~\cc{d}, the two
          prerequisites of recipe~\cc{n/d}, is free.
          ...
          and this recomputation returns \kk{True}.\footnote{% 
            Indeed, in the~\cc{.Rational} environment the undefined fraction~$1/0$ is
